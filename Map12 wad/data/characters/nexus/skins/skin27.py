...
entries: map[hash,embed] = {
    "Characters/Nexus/Skins/Skin27" = SkinCharacterDataProperties {
        championSkinName: string = "Nexus_BW_Red"
        ...
        skinMeshProperties: embed = SkinMeshDataProperties {
            ...
            texture: string = "ASSETS/Characters/Nexus/Skins/Skin27/BW_AP_ChaosNexus_TX_CM.dds"
